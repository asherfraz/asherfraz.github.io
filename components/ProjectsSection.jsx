...
const ProjectsSection = () => {
	...
	let val = "";
	const latestProjects = sortedProjects.slice(0, 6);
			...
			<div className="space-y-12 w-full  px-4 py-12">
						...
						>
							<div className="rounded-lg bg-white/5 text-white flex flex-col overflow-hidden border border-transparent hover:scale-96  hover:shadow-lg transition-all duration-300 ease-out h-full">
								<Link
									...
									href={
										(val = project.link || project.source) ? val : project.image
									}
								>
									<Image
										src={project.image}
				...
				{projects.length > 6 && (
					<div className="flex justify-center items-center">
						<Link href="/projects">
							<Button className="flex items-center justify-center border border-primary bg-transparent text-primary hover:bg-primary/30 hover:text-primary-foreground transition-colors duration-300 ease-in-out">
								View all projects
								<svg
									xmlns="http://www.w3.org/2000/svg"
									width="24"
									...
									strokeLinecap="round"
									strokeLinejoin="round"
									className="lucide lucide-arrow-right size-4 mr-2"
								>
